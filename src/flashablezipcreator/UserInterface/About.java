...
public class About extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        lblAboutMe.setText("<HTML> <RIGHT><B>Rajat Patel</B></RIGHT>  <br> I am <a href=\"https://forum.xda-developers.com/member.php?u=1852653\">Rajat Patel</a>, contributor to the development this tool, xda senior member, geek by heart, Business Analyst by Profession, football lover & Chelsea fan.<br>  Foreseen by Nikhil and coded by me and him together is this tool, saving your time in creating flashable zips for Android Recovery and lets you concentrate more on the actual work than creating a flashable!<br>  Happy flashing! </HTML>");
